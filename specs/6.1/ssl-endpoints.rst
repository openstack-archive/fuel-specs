...
- The user can upload its own certificate.

- Use a PKI described in the following blueprints:
  https://blueprints.launchpad.net/fuel/+spec/ca-deployment
  https://blueprints.launchpad.net/fuel/+spec/keytone-pki-deployment
...
it can manually uploads its certificate.
