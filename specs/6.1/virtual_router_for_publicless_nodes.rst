...
I propose divide work on this blueprint to some independed stages. Each stage,
except first, may be developed as parralel tasks and don't depends from another.
