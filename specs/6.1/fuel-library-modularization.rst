...
automatically so it’s fit for both local developer testing and centralized
...
* Step #1:
  ...
  * legacy.pp
  ...
  'legacy.pp' is based on our legacy site.pp manifest. So it's mostly like
  previous monolithic deployment scheme where everything was deployed with
