...
orchestrator uses different notation (see [1]). Variables ended with '__' will
...
available for certain modes only (see [1]).
...
This task can be postponed to the next stage.
...
Task 7 can be postponed to MOS 7.0.
