...
Also, Fuel cannot add vSphere clusters to an already deployed environment on the
...
Alternative solution to the problem would be rewriting */etc/nova/nova-compute.conf*
