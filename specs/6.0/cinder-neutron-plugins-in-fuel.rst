    ...
    - role: controller
      tasks:
        ...
        - stage: post_deploy
          type: puppet
          puppet_manifest: cinder_glusterfs.pp
          # NOTE(eli): Check if puppet can accept
          # modules as relative attribute
          puppet_modules: modules
          priority: 20
          timeout: 42
          cwd: /etc/fuel/plugins/plugin_name-1.0
    # ... The rest of deployment data for the role
    - role: cinder
      tasks:
        # Here are the same data as for controller tasks section
    # ... The rest of deployment data for the role
    - role: compute
      tasks: []
    # ... The rest of deployment data for the role
