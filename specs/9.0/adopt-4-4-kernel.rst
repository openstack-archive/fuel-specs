...
their cloud capacity. Next to that OVS and KVM may get improvements by upgrading
the Kernel.
...
Initial deployment of MOS 9.0 and upgrade to MOS 9.1 is not affected. Upgrade to
4.4 kernel can be applied manually on MOS 9.1 at any moment. It's much better to
apply it *before* deploying an environment, because it requires less work.
...
* Instructions for upgrade of existing MOS 9.0/9.1 environments into kernel v4.4
  are created and meet the following criteria:
