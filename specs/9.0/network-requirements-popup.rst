...
All networks or network parameters on the Network tab should be accompanied by
...
networks or network parameters to help End User to correctly set up the network
setting values.
...
There will be new info icons near network or network parameters titles on the
Network Settings tab, if End User mouse hover on it, additional information
about the requirements will be shown in the popover. These icons are visible
in all cases, even if the tab is locked.
