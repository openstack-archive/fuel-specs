...
Fuel openstack-config feature introduces a way to update OpenStack
...
puppet resource defined with fuel-library. New data format should be recognized
...
Tests for fuel openstack-config feature should be updated with new
