...
Fuel openstak-config feature introduces a way to update OpenStack configuration
files. User can upload yaml-formatted file using Fuel client. The format of this
file is following
...
type. For example following construction
