...
- add to nailgun support for correct serialization disks delivered by multipath
...
* Multipath devices have to be automatically detected and configured during node bootstrap

* Multipath devices have to be configured in Host OS
