...
`NodeBondInterfacePlugin` will be used to store actual state of plugin related
NICs, BONDs and Nodes attributes data per each interface, bond or node.
By default 'attributes' fields of this models should be filled with data from
plugin `nic_attributes_metadata`, `node_attributes_metadata` and
...
`/nodes/:id/interfaces/` API call. Same logic will be used for BOND and Node
attributes.
...
===== ========================================= ============================
GET   /api/v1/nodes/bonds/attributes/default    Get default bond attributes
                                                for specific release
===== ========================================= ============================


The response format for GET `/nodes/bonds/attributes/default`:
