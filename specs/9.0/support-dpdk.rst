...
The nailgun will compare PCI-ID against hardcoded into `settings.yaml` list of
supported hardware. List of supported hardware should be:

* Release specific

* Contains dpdk driver name for every PCI-ID, that used in network_scheme
