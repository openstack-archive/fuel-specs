...
.. code-block:: yaml
  ...
  releases:
    ...
    - os: ubuntu
      ...
      components_path: components.yaml
      deployment_tasks_path: deployment_tasks.yaml
      environment_config_path: environment_config.yaml
      network_roles_path: network_roles.yaml
      node_roles_path: node_roles.yaml
      volumes_path: volumes.yaml
      node_roles_path: node_roles.yaml
