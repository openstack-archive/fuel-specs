...
It means that there is no elegant way for User to use extensions
capabilities.
...
* Notification when extensions is enabled/disabled for cluster/release.
...
* Possibility to change extensions to cluster/releases from WebUI

* Possibility to change extensions to cluster/releases from Fuel CLI
