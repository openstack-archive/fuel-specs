...
.. code-block:: yaml
  ...
  cgroups:
    ...
    memory:
      label: memory
      type: textarea
      value: "memory.soft_limit_in_bytes:\n  - nova: 5242880\nmemory.limit_in_bytes:\n\
        \  - neutron: %30, min, max\nmemory.swappiness:\n  - mysqld: 0\n  - rabbitmq:\
        \ 0"
    ...

New block 'cgroups' will be introduced into cluster's settings tab under 'general' group.
Cgroups limits will be described in yaml format into 'textarea' fields. Format will be explicitly
described in feature's documetation.
