...
value will be always set to 1 and increased in case of package modification.
...
and be based on the last stable commit from *updates* or *stable* branch in
...
All further work transferring into "updates" branch, this means all next
...
Transformations withing ongoing MOS releases as for dependecies as for
OpenStack projects::
...
From out of the box *YUM* package manager hasn't ability to use repository
priorities. This functionality available via yum plugin named
