...
The support for RPM repositories will be added to the `fuel-createmirror`_
script.

.. _fuel-createmirror: https://github.com/stackforge/fuel-mirror
...
* System tests for CentOS will be adjusted to reflect the new repositories
  scheme for MOS packages and base OS packages.
...
* RPM packages built for OpenStack environments will be stored separately
...
and should be based on the last stable commit from *updates* or *stable* branch
in case of absence of published updates.
...
* Modify default RPM repositories in Nailgun
