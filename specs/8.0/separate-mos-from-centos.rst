...
process and generated by %{?dist} macro. This macro must be replaced with new
value which represents *MOS release* during package build process.

Example::

    python-iso8601-0.1.10-1.el7 -> python-iso8601-0.1.10-1.mos8.0
...
Example::
    ...
    python-iso8601-0.1.10-1.mos8.0 -> python-iso8601-0.1.10-2.mos8.0
    python-iso8601-0.1.10-2.mos8.0 -> python-iso8601-0.1.10-3.mos8.0
    python-iso8601-0.1.10-3.mos8.0 -> python-iso8601-0.1.11-1.mos8.0

Updates within release
++++++++++++++++++++++

If required to make updated packages within same release **mu** suffix can be add
after **mos**.
