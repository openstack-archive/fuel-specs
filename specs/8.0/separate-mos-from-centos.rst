...
Any changes into *security-updates* branch should consist only CVE security fixes
...
After GA, *stable* branch should be freezed and do not accept any changes.
...
will be committed into *security-updates*, published with minimal testing into
security-updates package repositories and also pushed into *updates* branches to
keep these changes.
