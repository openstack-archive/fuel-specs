...
- !os_env_get ISO_PATH                # ISO_PATH is the required variable
...
* driver: There is configured a name of python module where the driver methods
  are located, and additional driver-specific parameters.
...
* network_pools: Reserve address pools and VLAN tags for networks in the
  ...
  -  baremetal pool: if 'net' is specified as x.x.x.x/YY , then the network is
     stored 'as is', 'gateway' and at less one element in 'ip_ranges' is
     required.
        ...
        groups:  # type: list of dicts
         - name: rack-01
           ...
           network_pools:  # type: dict of lists
             ...
             fuelweb_admin:
              - net: !os_env_get POOL_DEFAULT, 10.109.0.0/16:24
                tag: 0
