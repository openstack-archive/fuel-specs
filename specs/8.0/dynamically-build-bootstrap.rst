...
--ubuntu-repo REPOSITORY
  Add ubuntu upstrean mirror repo.
...
REPOSITORY format:
    repository are iterable - so you can pass multiply links.
    --repository 'uri distribution [component1],[priority1] [component2],[priority2]'
    --repository 'http://mirror.fuel-infra.org/mos-repos/ubuntu/8.0 mos8.0 main,priority=1101'
    Apt_pinning_docs_.
.. _Apt_pinning_docs: https://www.debian.org/doc/manuals/debian-reference/ch02.en.html#_tweaking_candidate_version
...
--package-list-file FILE_PATH   Install list of packages. Package names listed
                                in the given file.Files will be injected before
                                initram-fs processes.
