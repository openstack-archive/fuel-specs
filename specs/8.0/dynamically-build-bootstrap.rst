...
bootstrap files in simply tar.gz archive, which also can be simple created
manyally by user, w\o mkbootstrap script.
...
.. code-block:: bash
  ...
  $ cat metadata.yaml
    extend_kopts : 'boot=live toram components fetch=http://${server}:8080/bootstraps/active_bootstrap/root.squashfs biosdevname=0'
    uuid : a928605c-1f47-4df3-90e0-1374e2abad9e
    description : "my tested ubuntu-based bootstrap"
