...
.. code-block:: bash
  ...
  $ fuel-bootstrap build 
         ...Assembling bootstrap with default parameters...
                            ...
         ...Assembling done..
         ...Bootstrap saved to /tmp/latest-ubuntu-bootstrap.tar.gz...
         ...Bootstrap UUID: 765556d0-8b8e-4017-89e0-a5feb4d4518e ...
  $ fuel-bootstrap import /tmp/latest-ubuntu-bootstrap.tar.gz
  $ fuel-bootstrap activate 765556d0-8b8e-4017-89e0-a5feb4d4518e
  # or in one command:
  $ fuel-bootstrap import /tmp/latest-ubuntu-bootstrap.tar.gz --activate
...
.. code-block:: bash
  ...
  --direct-repo-addr            Nodes with such address will be connected to the repositories
                                without proxy

  --ubuntu-repo 'http://archive.ubuntu.com/ubuntu trusty main universe multiverse restricted'

  --mos-repo REPOSITORY         Add link to repository with fuel* packages.
...
.. code-block:: bash
  ...
  --repo 'uri distribution [component],[priority]'
  --repo 'http://mirror.fuel-infra.org/mos-repos/ubuntu/8.0 mos8.0 main,priority=1101'
  --repo 'http://mirror.fuel-infra.org/mos-repos/ubuntu-test/9.0 mos9.0 main,priority=1120'
...
.. code-block:: bash
  ...
  --script FILE_PATH            The script is executed after installing
                                ...
                                system and made any custom changes  with
...
.. code-block:: bash
  ...
  --ubuntu-release             Defines the Ubuntu release (Currently supports only trusty)
...
.. code-block:: bash
   ...
   $ fuel-bootstrap build --output-dir /tmp/ --ubuntu-repo 'http://archive.ubuntu.com/ubuntu trysty main' --repo 'http://mirror.fuel-infra.org/mos-repos/ubuntu/8.0 mos8.0 main,priority=1101' --repo 'http://me.example.com/my-openstack kilo main,priority=1104' --package screen
