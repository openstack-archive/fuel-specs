...
The '--repository' option can be specified multiple times, several repositories will be added.
...
**Note** Files/packages will be injected after installing all mandatory packages, 
  but before generating system initramfs - so you can add something specific, like 
  udev rules or kernel modules. Same for --script parameter.
