...
* Expected jobs workload will be double increased, because of triggering the
  same number of jobs (as for CentOS 6), but for CentOS 7
...
Related mirrors should be created in all location with the `base` path defined below:
