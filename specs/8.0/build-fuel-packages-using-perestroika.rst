...
must download all required packages from MOS mirrors.
...
repos. The new workflow should be applied: packages MUST be build in
Perestroika and customized repos with packages should pass to make system as
...
Perestroika must support building customized repo from patchsets, provided by
developer
