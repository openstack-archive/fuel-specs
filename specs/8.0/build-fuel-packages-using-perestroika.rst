...
process. All these packages resides on stackforge [1]_

+--------------------+---------------+---------------------+------+-----+
|    Repo-name       | RPM packages  |     DEB packages    | P-CR | P-M |
+====================+===============+=====================+======+=====+
|   fuel-agent       |  fuel-agent   |      fuel-agent     |  +   |  +  |
+--------------------+---------------+---------------------+------+-----+
|   fuel-astute      |  fuel-astute  |      fuel-astute    |  +   |  +  |
+--------------------+---------------+---------------------+------+-----+
|   fuel-library     |               | - fuel-ha-utils     |  +   |  +  |
|                    |               | - fuel-misc         |  +   |  +  |
|                    |               | - fuel-rabbit-fence |  +   |  +  |
+--------------------+---------------+---------------------+------+-----+
|   fuel-main        |               |                     |  +   |  +  |
...
.. [1] `Fuel stackforge repos <https://link>`_
