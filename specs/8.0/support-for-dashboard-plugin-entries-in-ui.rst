...
`REST API`_. Plugin entries will be sorted by 'id' attribute.
...
The special ``/cluster/:id/dashboard_entries`` url will be available, by
GETting which it will be possible to get the list of dashboard entries.
