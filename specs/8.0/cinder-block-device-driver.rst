...
A new Puppet task should be added. The task should be responsible for provisioning
the cinder.conf changes and running all needed processes on appropriate nodes.
