...
Operator doesn't have tools to modify OpenStack options after cloud is deployed.
...
node and make config changes, which can be later overriden by Fuel's puppet run.
