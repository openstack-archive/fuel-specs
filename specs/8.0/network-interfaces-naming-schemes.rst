...
naming. Such a naming scheme is known to be unstable in the following ways:
...
By default, systemd/upstart will name Ethernet interfaces using different from
...
Switching to 'predictable network interfaces' some changes in documentation.
Diagrams and User Guide should be review to support new network
schemes.
