...
#. The existing Settings tab will be restructured - they will split
  ...
  * OpenStack Services
  ...
  Plugins can provide any group from the list above. In case if plugin will
  try to use custom group name (not from the predefined list) it will
  automatically go to the 'Other' group.
