...
`equipment::nodes` group is introduced. This group is defining that
plugin links to the master node plugin dashboard is also displayed on the
equipment (nodes) panel of web GUI.
