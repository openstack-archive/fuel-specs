...
* For user should be available all operations with environment which
  are provided through Fuel UI;
* NSX and vCenter must be stable for all destructive tests that we have
  for these features;
