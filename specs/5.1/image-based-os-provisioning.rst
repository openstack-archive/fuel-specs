...
Canonical [1] and RedHat [2]. It is again much more
...
where user_data is supposed to be a multipart mime file [3].
This file will contain puppet and mcollective configurations as well as
the executable script implementing all that stuff which is now exists
...
Cloud-init configuration file example is here [4].
