...
- Add DIB based targets into ISO build script for building golden bare
  OS images (Ubuntu and Centos). They are not supposed to be highly customized.
  (Iteration 1)
- Write discovery agent script. (Iteration 1)
- Write provisioning agent script. (Iteration 1)
    * partitioning
