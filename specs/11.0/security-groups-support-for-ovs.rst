...
It is required to implement a radiobutton in Fuel to switch a firewall driver.
...
as rules for OVS. Therefore, we should have an attribute in Fuel for selecting
firewall driver.
          ...
          security_groups:
            ...
            values:
              - data: "ovs_firewall"
                ...
                description: "Choose this type of firewall driver if you use OVS Brige for networking needs."
