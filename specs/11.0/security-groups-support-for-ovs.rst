...
Due to complex upgrade procedure [0] the feature is available for new
deployments only.
...
Rerun the deployment with changing a firewall driver is possible only in
absence instances case.
