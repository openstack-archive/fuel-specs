...
To make updates/upgrades simpler, it's supposed that plugin could contain only
one release and nothing except it if release is defined. FPB validator should
...
.. code-block:: yaml
  ...
  fuel_version: ['9.1', '10.0']  # should be '9.1' or above
