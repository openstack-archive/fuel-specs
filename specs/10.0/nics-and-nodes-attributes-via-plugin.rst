...
client will be splited and stored between these two tables. Same logic will be
...
In case of additional to core NIC and BOND attributes, GET
`/nodes/:id/interfaces/` method should return data with the
following structure:
