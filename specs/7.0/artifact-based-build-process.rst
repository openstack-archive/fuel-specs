...
- *Ability to test components independently*
  ...
  It is absolutely unnecessary to deploy the Fuel master node and use it as an
...
stable enough to be used in production. Unfortunately, neither Maven nor Gradle
...
particular component should be an artifact.
...
#. Refactoring of make system
  ...
  to building "level-1" packages. Besides, such packages usually
