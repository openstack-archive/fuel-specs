...
Connectiong FUEL to external ceph cluster is a hightly requested
customer feature. Currently this can be done only ad-hoc by manually
editing openstack config files after deployment is done via FUEL.
