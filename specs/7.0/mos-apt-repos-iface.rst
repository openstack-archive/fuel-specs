...
deb http://${mirror_host}/mos/ubuntu mos${mos_release}-${distro_codename}          main
deb http://${mirror_host}/mos/ubuntu mos${mos_release}-${distro_codename}-security main
deb http://${mirror_host}/mos/ubuntu mos${mos_release}-${distro_codename}-updates  main
deb http://${mirror_host}/mos/ubuntu mos${mos_release}-${distro_codename}-proposed main
deb http://${mirror_host}/mos/ubuntu mos${mos_release}-${distro_codename}-holdback main
