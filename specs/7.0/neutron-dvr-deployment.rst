...
* Fuel Library related changes
  ...
  * Update Neutron Puppet module to support DVR-related options (L3 agent mode,
    L2 population, distributed router reviewers). This step will be done as a
    part of blueprint upgrade-openstack-puppet-modules, when all necessary
    changes will be synced from puppet-neutron project
