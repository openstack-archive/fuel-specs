...
GET /api/networkverify/cluster/X/tests
...
PUT /api/networkverify/cluster/X/verify
...
GET /api/networkverify/cluster/X/tasks

return all the tasks associated with the check. Returns finished, current and waiting tasks
